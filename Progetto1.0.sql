...
CREATE TRIGGER controllo_sharing_multiplo    
...
preleva: LOOP
            ...
            SET @valido = (SELECT COUNT(CodSharing)
							FROM RideSharing
                            WHERE CodSharing = sharing + 1);
...
INSERT INTO `progetto`.`limitidivelocita` (`CodLimite`, `ValoreLimite`, `kmFine`, `kmInizio`, `CodStrada`) VALUES ('3', '70', '50', '21', '1');
