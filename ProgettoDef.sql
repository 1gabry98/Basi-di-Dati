...
CREATE TABLE ValutazioneFruitoreNoleggio (
    CodVoto INT UNSIGNED NOT NULL AUTO_INCREMENT,
    IdProponente INT UNSIGNED NOT NULL,
    IdFruitore INT UNSIGNED NOT NULL,
...
CREATE TABLE StelleFruitorePool (
    ...
    PiacereViaggio INT UNSIGNED NOT NULL,
    Serieta INT UNSIGNED NOT NULL,
    Comportamento INT UNSIGNED NOT NULL,
    PRIMARY KEY (CodVoto),
    FOREIGN KEY (Id)
        REFERENCES Utente (Id)
        ON DELETE CASCADE
...
CREATE PROCEDURE CalcolaCoda(IN _codsharing INT)
BEGIN
...
-- CAR SHARING
INSERT INTO PrenotazioneDiNoleggio (DataInizio, DataFine, idFruitore, Targa, Prezzo) VALUES ('2018-12-29 20:00:00', '2018-12-29 21:00:00', '2', 'AE987CB','200');
...
INSERT INTO `progetto`.`valutazionefruitorenoleggio` (`IdProponente`, `IdFruitore`, `Recensione`) VALUES ('2', '1', 'INSOMMA');
...
-- RIDE SHARING
INSERT INTO `progetto`.`ridesharing` (`IdFruitore`, `OraPartenza`, `Targa`) VALUES ('2', '2018-12-21 11:00:00', 'AE987CB');
...
INSERT INTO `progetto`.`ridesharing` (`IdFruitore`, `OraPartenza`, `Targa`) VALUES ('4', '2018-12-29 11:00:00', 'AW123OB');
...
INSERT INTO `progetto`.`ridesharing` ( `IdFruitore`, `OraPartenza`, `Targa`) VALUES ('3', '2018-12-29 11:00:00', 'AE987CB');
...
INSERT INTO `progetto`.`ridesharing` (`IdFruitore`, `OraPartenza`, `Targa`) VALUES ('6', '2018-12-29 15:00:00', 'AW123OB');
...
CALL NumeroServiziErogati(2);
CALL NumeroServiziErogati(3);
CALL NumeroServiziErogati(4);
CALL NumeroServiziErogati(5);
CALL NumeroPostiRimanentiSharing(1);
